...
class MainLoop(AbstractEventLoop):
    ...
    def register_signal_source(self, signal_source):
        ...
        """
        self._active_queue.add_unique_source(signal_source)
    ...
    def enqueue_signal(self, signal):
        ...
        If it is not belong anywhere enqueue it to the active one.
        ...
        """
        for i in range(len(self._event_queues), 0):
            queue = self._event_queues[i]
